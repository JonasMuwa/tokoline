...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link rel="icon" href="assets/img/13.png" sizes="32x32" type="image/png">
  ...
  <body>
    ...
    <!-- Fixed navbar -->
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue padding: 20px 0;" style="background: #FF869E">
      <div class="container" style="background: #A10035">
      ...
      <li><a href="<?php echo $url ?>pembayaran.php">Pembayaran</a></li>      
			...
			<?php } ?>
            <li><a href="<?php echo $url ?>admin/login.php">Admin</a></li>
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner col-12">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/gam1.jpg');"></div>
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/gam2.jpg');"></div>
                <div class="carousel-caption">
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			<div style="background:#F94C66; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px;">
			<h4 style="text-white">Kategori Produk</h4>
			</div>
			<ul class="kategori">
				<?php 
			...
			<div style="background:#F94C66; width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px; 	margin-bottom:15px;">
			...
			<div class="row col-md-12">
				<hr>
				<img src="<?php echo $url.'assets/img/2.jpg'; ?>" width="100%"><br><br>
				<img src="<?php echo $url.'assets/img/6.jpg'; ?>" width="100%"><br><br>
        <img src="<?php echo $url.'assets/img/10.jpg'; ?>" width="100%">
			</div>
		</div>