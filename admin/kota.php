<?php 
	...
	if(!empty($_GET['act']) && $_GET['act'] == 'edit'){
		if(!empty($_POST)){ 
			extract($_POST);
			$q = mysqli_query($conn, "update kota SET nama='$nama',ongkir='$ongkir' where id=$_GET[id]") or die(mysql_error());
			if($q){
				alert("Success"); redir("kota.php");
			}
		}
...
?> 
	...
	<div class="container">
		...
		<a class="btn btn-sm btn-primary" href="kota.php?act=create">Tambah Data</a>
		<hr>
		<?php
			if(!empty($_GET)){
				if($_GET['act'] == 'create'){
