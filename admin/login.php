...
<?php
	...
	if(!empty($_POST)){
		...
		$q = mysqli_query($conn, "SELECT * FROM user WHERE email='$email' AND password='$password' AND status='admin'") or die(mysql_error());
		if($q){
...
<html >
  ...
  <body>
      ...
      <div class="wrapper">
    <form class="form-signin" action="" method="POST" style="background-image: url(assets/img/buk.jpg);">       
